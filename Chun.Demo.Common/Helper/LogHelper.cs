...
namespace Chun.Demo.Common.Helper {
    ...
    public class LogHelper {
        ...
        private static readonly string LogPath =
            Path.Combine(Path.GetDirectoryName(typeof(LogHelper).Assembly.Location), path2: "logs\\");
        ...
        public static void InitLogManager() {
            ...
            fileTarget.Layout =
                "${longdate} Thread ${ThreadId} ${pad:padding=5:inner=${level:uppercase=true}} | ${message}";
